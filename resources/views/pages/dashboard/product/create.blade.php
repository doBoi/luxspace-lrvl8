<x-app-layout>
  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      @endif
      <form action="{{ route('dashboard.product.store') }}" class="w-full p-2" method="post"
        enctype="multipart/form-data">
        @csrf
        <div class="flex flex-wrap -mx-3 mb-6 ">
          <div class="w-full px-3">
            <label for="" class="block uppercase tracking-white text-gray-700 text-xs font-bold mb-2">Name</label>
            <input type="text" placeholder="Product Name" value="{{ old('name') }}" name="name"
        ...
        <div class="flex flex-wrap -mx-3 mb-6 ">
          <div class="w-full px-3 ">
            <label for=""
              class="block uppercase tracking-white text-gray-700 text-xs font-bold mb-2">Description</label>
        ...
        <div class="flex flex-wrap -mx-3 mb-6 ">
          <div class="w-full px-3 ">
            <label for="" class="block uppercase tracking-white text-gray-700 text-xs font-bold mb-2">Price</label>
            <input type="number" placeholder="Product Price" value="{{ old('price') }}" name="price"
              class="block w-full bg-gray-200 text-gray-700 border boder-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
          </div>
        </div>
