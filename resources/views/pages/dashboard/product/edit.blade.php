      ...
      <form action="{{ route('dashboard.product.update',$item->id) }}" class="w-full " method="post"
        ...
        <div class="flex flex-wrap -mx-3 mb-6 ">
          <div class="w-full px-3">
            ...
            <input type="text" placeholder="Product Name" value="{{ old('name') ?? $item->name }}" name="name"
        ...
        <div class="flex flex-wrap -mx-3 mb-6 ">
          <div class="w-full px-3 ">
            ...
            <input type="number" placeholder="Product Price" value="{{ old('price') ?? $item->price }}" name="price"
              class="block w-full bg-gray-200 text-gray-700 border boder-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
          </div>
        </div>
