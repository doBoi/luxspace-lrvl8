      ...
      <div class="w-auto">
        <ul
          ...
          <li class="mx-3 py-6 md:py-0">
            <a href="#"
              class="{{ \Route::current()->getName() == 'index' ? 'text-black md:text-white' : 'text-black'}} hover:underline">Showcase</a>
          </li>
          <li class="mx-3 py-6 md:py-0">
            <a href="#"
              class="{{ \Route::current()->getName() == 'index' ? 'text-black md:text-white' : 'text-black'}} hover:underline">Catalog</a>
          </li>
          <li class="mx-3 py-6 md:py-0">
            <a href="#"
              class="{{ \Route::current()->getName() == 'index' ? 'text-black md:text-white' : 'text-black'}} hover:underline">Delivery</a>
          </li>
          <li class="mx-3 py-6 md:py-0">
            <a href="#"
              class="{{ \Route::current()->getName() == 'index' ? 'text-black md:text-white' : 'text-black'}} hover:underline">Rewards</a>
          </li>

          @auth
          <li class="mx-3 py-6 md:py-0">
            <a href="{{ route('dashboard.index') }}"
              class="{{ \Route::current()->getName() == 'index' ? 'text-black md:text-white' : 'text-black'}} hover:underline">Dashboard</a>
          </li>
          @endauth
          @guest
          <li class="mx-3 py-6 md:py-0">
            <a href="{{ route('login') }}"
              class="{{ \Route::current()->getName() == 'index' ? 'text-black md:text-white' : 'text-black'}} hover:underline">Login</a>
          </li>
          <li class="mx-3 py-6 md:py-0">
            <a href="{{ route('register') }}"
              class="{{ \Route::current()->getName() == 'index' ? 'text-black md:text-white' : 'text-black'}} hover:underline">Register</a>
          </li>
          @endguest
        </ul>
      </div>
        ...
        <ul class="items-center flex">
          <li class="ml-6 block md:hidden">
            <button id="menu-toggler"
              class="relative flex z-50 items-center justify-center w-8 h-8 {{ \Route::current()->getName() == 'index' ? 'text-black md:text-white' : 'text-black'}} focus:outline-none">
          ...
          <li class="ml-6">
            <a id="header-cart"
              class="flex items-center justify-center w-8 h-8 {{ \Route::current()->getName() == 'index' ? 'text-black md:text-white' : 'text-black'}}"
              href="{{ route('cart') }}">
